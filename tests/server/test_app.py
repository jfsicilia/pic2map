...
class RouteTest(unittest.TestCase):
    ...
    def test_index(self):
        ...
        row_to_serializable_patcher = patch(
            "pic2map.server.app.row_to_serializable"
        )
        with render_template_patcher as render_template, location_db_patcher as location_db_cls, row_to_serializable_patcher as row_to_serializable_mock:
