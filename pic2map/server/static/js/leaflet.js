    ...
    (o.Mixin = {}),
        ...
        (o.DomUtil = {
            ...
            getViewportOffset: function (t) {
                ...
                do {
                    if (
                        ...
                        (n +=
                            parseInt(
                                o.DomUtil.getStyle(a, "borderTopWidth"),
                                10
                            ) || 0),
                        (s +=
                            parseInt(
                                o.DomUtil.getStyle(a, "borderLeftWidth"),
                                10
                            ) || 0),
            ...
            getScaleString: function (t, e) {
                var i = o.DomUtil.getTranslateString(
                        e.add(e.multiplyBy(-1 * t))
                    ),
                    n = " scale(" + t + ") ";
                return i + n;
            },
        ...
        (o.Map = o.Class.extend({
            ...
            _updateZoomLevels: function () {
                ...
                for (t in this._zoomBoundLayers) {
                    ...
                    isNaN(s.options.minZoom) ||
                        (e = Math.min(e, s.options.minZoom)),
                        isNaN(s.options.maxZoom) ||
                            (n = Math.max(n, s.options.maxZoom));
                }
                t === i
        ...
        (o.TileLayer.WMS = o.TileLayer.extend({
            ...
            getTileUrl: function (t) {
                ...
                return (
                    l +
                    o.Util.getParamString(this.wmsParams, l, !0) +
                    "&BBOX=" +
                    h
                );
            },
        ...
        (o.ImageOverlay = o.Class.extend({
            ...
            bringToBack: function () {
                ...
                return (
                    this._image && t.insertBefore(this._image, t.firstChild),
                    this
                );
            },
            setUrl: function (t) {
            ...
            _animateZoom: function (t) {
                var e = this._map,
                    ...
                    h = e
                        ._latLngToNewLayerPoint(a, t.zoom, t.center)
                        ._subtract(r),
            ...
            _reset: function () {
                var t = this._image,
                    e = this._map.latLngToLayerPoint(
        ...
        (o.Marker = o.Class.extend({
            ...
            _initInteraction: function () {
                if (this.options.clickable) {
                    ...
                    // Allows vimium to interact with the map markers.
        ...
        (o.Popup = o.Class.extend({
            ...
            initialize: function (t, e) {
                o.setOptions(this, t),
                    (this._source = e),
                    (this._animated =
                        o.Browser.any3d && this.options.zoomAnimation),
                    (this._isOpen = !1);
            },
            onAdd: function (t) {
            ...
            _adjustPan: function () {
                if (this.options.autoPan) {
                    ...
                    var s = t.layerPointToContainerPoint(n),
                        ...
                        h = o.point(
                            this.options.autoPanPaddingBottomRight || a
                        ),
                        l = t.getSize(),
                        u = 0,
                        c = 0;
                ...
                return (
                    this._popup &&
                        ((t =
                            ...
                            this._latlng ||
                            this._latlngs[
                                Math.floor(this._latlngs.length / 2)
                            ]),
                              ...
                              i.stroke
                                  ? (t ||
                                    ...
                                    (t.dashStyle = i.dashArray
                                        ...
                                        : ""),
                                    i.lineCap &&
                                        (t.endcap = i.lineCap.replace(
                                            "butt",
                                            "flat"
                                        )),
                                    i.lineJoin && (t.joinstyle = i.lineJoin))
                                  : t &&
                                    (n.removeChild(t), (this._stroke = null)),
                              i.fill
                                  ? (e ||
                                        ((e = this._fill =
                          ...
                          if (!this._checkIfEmpty()) {
                              ...
                              this._drawPath(),
                                  ...
                                  e.fill &&
                                      ...
                                      t.fill()),
                                  e.stroke &&
                                      ((t.globalAlpha = e.opacity), t.stroke()),
                                  t.restore();
                          }
                      },
                      _initEvents: function () {
            ...
            closestLayerPoint: function (t) {
                for (
                    ...
                    for (var l = s[r], u = 1, c = l.length; c > u; u++) {
                        (e = l[u - 1]), (i = l[u]);
                        var d = o.LineUtil._sqClosestPointOnSegment(
                            t,
                            e,
                            i,
                            !0
            ...
            _initWithHoles: function (t) {
                ...
                if (t && o.Util.isArray(t[0]) && "number" != typeof t[0][0])
                    for (
                        ...
                        (n = this._holes[e] =
                            this._convertLatLngs(this._holes[e])),
                ...
                ? {
                      _containsPoint: function (t) {
                          var e,
                              ...
                              u = !1;
                          if (
                              o.Polyline.prototype._containsPoint.call(
                                  this,
                                  t,
                                  !0
                              )
    ...
    o.Marker.include(a),
            ...
            _getEvent: function () {
                ...
                if (!e)
                    for (
                        ...
                        i &&
                        ((e = i.arguments[0]), !e || t.Event !== e.constructor);
        ...
        (o.Control.Scale = o.Control.extend({
            ...
            _update: function () {
                var t = this._map.getBounds(),
                    ...
                    n =
                        (i * (t.getNorthEast().lng - t.getSouthWest().lng)) /
                        180,
                    o = this._map.getSize(),
                    s = this.options,
                    a = 0;
        ...
        (o.PosAnimation = o.Class.extend({
            ...
            _getPos: function () {
                ...
                if (o.Browser.any3d) {
                    if (
                        ((n = a[o.DomUtil.TRANSFORM].match(this._transformRe)),
                        !n)
                    )
                        return;
