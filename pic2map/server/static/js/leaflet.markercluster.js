    ...
    (L.MarkerClusterGroup = L.FeatureGroup.extend({
        ...
        _removeLayer: function (t, e, i) {
            ...
            for (
                ...
                _ && (_._childCount--, !(_._zoom < 0));

            )
                e && _._childCount <= 1
                    ? ((h =
                          _._markers[0] === t ? _._markers[1] : _._markers[0]),
                      n[_._zoom].removeObject(
                          _,
                          o.project(_._cLatLng, _._zoom)
                      ),
                      s[_._zoom].addObject(
                          h,
                          o.project(h.getLatLng(), _._zoom)
                      ),
                              ...
                              this._enqueue(function () {
                                  if (1 === t._childCount) {
                                      ...
                                      t._recursively(n, i, 0, function (t) {
                                          t._recursivelyRemoveChildrenFromMap(
                                              n,
                                              e + 1
                                          );
                                      });
        ...
        (L.MarkerCluster = L.Marker.extend({
            ...
            _expandBounds: function (t) {
                ...
                this._wLatLng
                    ? ((this._wLatLng.lat =
                          (i.lat * e + this._wLatLng.lat * this._childCount) /
                          n),
                      (this._wLatLng.lng =
                          (i.lng * e + this._wLatLng.lng * this._childCount) /
                          n))
                ...
                this._recursively(
                    ...
                    function (t) {
                        ...
                        for (i = s.length - 1; i >= 0; i--)
                            (n = s[i]),
                                n._icon && (n._setPos(e), n.setOpacity(0));
                    },
                    function (t) {
                        var i,
                            n,
                ...
                ? {
                      ...
                      _animationSpiderfy: function (t, i) {
                          ...
                          if ((a.setOpacity(0.3), L.Path.SVG))
                              for (
                                  this._group._forceLayout(), n = t.length - 1;
                                  n >= 0;
                                  n--
                              )
                                  (s = t[n]._spiderLeg),
                                      (s.options.opacity = 0.5),
                                      s._path.setAttribute(
                                          "stroke-opacity",
                                          0.5
                                      );
                          setTimeout(function () {
                          ...
                          for (
                              ...
                              (e = h[i]),
                                  e._preSpiderfyLatlng &&
                                      ...
                                      _ &&
                                          ((n =
                                              e._spiderLeg._path.childNodes[0]),
                                          n.setAttribute(
                                              "to",
                                              n.getAttribute("from")
                                          ),
                                          ...
                                          n.beginElement(),
                                          (n =
                                              e._spiderLeg._path.childNodes[1]),
                                          n.setAttribute("from", 0.5),
                                          n.setAttribute("to", 0),
                                          n.setAttribute("stroke-opacity", 0),
                                          n.beginElement(),
                                          e._spiderLeg._path.setAttribute(
                                              "stroke-opacity",
                                              0
                                          )));
                          setTimeout(function () {
